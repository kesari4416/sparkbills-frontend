...
export default function PlatformDashboard() {
  ...
  const cards = [
    { k: "tenants_total",    label: "Total Tenants",    icon: Building2, tint: "from-blue-500 to-blue-800" },
    ...
    { k: "users_total",      label: "Users (all tenants)", icon: Users,   tint: "from-purple-500 to-purple-800" },
  ...
  return (
    <div className="p-8 space-y-6 text-white" data-testid="platform-dashboard">
      <div>
        ...
        <p className="text-sm text-blue-200/60 mt-1">Cross-tenant metrics across every Sparkbills business.</p>
      </div>
      ...
      <Card className="rounded-sm p-6 bg-white/[0.03] border-white/10 text-white">
        <div className="flex items-center gap-2 mb-4">
          ...
          <div className="text-[10px] uppercase tracking-widest text-blue-400 font-semibold">Tenants by industry lock</div>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          {Object.keys(stats.by_industry || {}).length === 0 && (
            <div className="text-sm text-blue-200/50 col-span-full">No tenants yet.</div>
          )}
        </div>
      </Card>
    </div>
